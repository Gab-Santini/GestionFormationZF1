	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "<span class='itemsPerPage'>Employés par page:</span> _MENU_",
				...
				"sInfoPostFix": "",
				"sInfoThousands": ",",
				"sSearch": "<span class='itemsPerPage'>Recherche:</span>",
				"sUrl": "",
				"oPaginate": {
					"sFirst":    "Premier",
					"sPrevious": "Précédent",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text"  /><div class="srch"></div>';
